  ...
  const handle_gd_Submit = async (e) => {
    ...
    try {
      if (isEditMode) {
        ...
        await submit_gd_FormData(finalData);
        toast.success("Guard registered successfully!");
      }
      resetForm();
      setRefreshTrigger((prev) => !prev);
      ...
      <div style={styles.container}>
        ...
        <div style={styles.formBox}>
          ...
          <form onSubmit={handle_gd_Submit}>
            ...
            {/* ✅ RANK DROPDOWN WITH OTHER OPTION */}
            <div className="form-group">
              <label>Guard Rank</label>
              <select
                name="rank"
            ...
            {/* ✅ STATUS DROPDOWN REMOVED (DEFAULT = INACTIVE) */}

            <SubmitButton
              label={
                isEditMode ? "Update Guard Details" : "Submit Guard Details"
              }
            />
