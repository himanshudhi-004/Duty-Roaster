...
export default function AdminProfile() {
  ...
  const { handleEdit } = useAdminStore();
  const { setSelectedAdmin } = useAdminStore();
  console.log("AdminProfile Component Rendered",setSelectedAdmin);
            ...
            <div style={styles.rightBox}>
              ...
              <div style={{ marginTop: "20px" }}>
                <button
                  ...
                  onClick={() => {
                    handleEdit(userDetails);   // save data in context
                    navigate("/adminedit");    // navigate to edit page
                  }}
                >
