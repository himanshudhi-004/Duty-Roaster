...
export default function VipNavbar() {
  ...
  const handleLogout = (e) => {
    e.preventDefault();
    const result = vipLogout(); // remove token
    if (result.success) {
      navigate("/login");
    } else {
              ...
              >
                <li className="dropdown-item-text text-center">
                  <img
                    ...
                    height="60"
                  />
                  <h6 className="mb-0">Vip</h6>
                  <small className="text-muted">vip@gmail.com</small>
                </li>
                <li>
                  <div className="dropdown-divider"></div>
                </li>
                <li>
                  <NavLink className="dropdown-item" to="/vipprofile">
                    My Profile
                  </NavLink>
                </li>
                <li>
