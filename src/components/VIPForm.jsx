...
export default function VIPForm() {
  ...
  // ✅ NEW STATE FOR "OTHER" DESIGNATION
  ...
  const handleSubmit = async (e) => {
    ...
    const finalData = {
      ...
      status: "Inactive", // ✅ ALWAYS SEND INACTIVE
    };

    try {
      if (isEditMode) {
        await updateVip(formData.id, finalData);
        toast.success("VIP detail Updated successfully!");
      } else {
        await submit_vip_FormData(finalData);
      ...
      <div style={styles.container}>
        ...
        <div style={styles.formBox}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* ✅ STATUS FIELD REMOVED FROM UI (DEFAULT INACTIVE) */}

            <SubmitButton
              label={
                isEditMode ? "Update VIP Details" : "Submit VIP Details"
              }
            />
